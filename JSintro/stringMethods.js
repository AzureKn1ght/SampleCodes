...
var subStr1 = myStr.slice(4,11);  // returns starting position and up to (but not including) the ending position 11
var subStr2 =  myStr.slice(12); //returns part of the string from position 10, all the way to the end
console.log(subStr1);
console.log(subStr2);
...
console.log(myStr.replace('feel','game')) //finds ALL and replace
...
var str1 = "$20,000";
var matches = str1.match(/(\d+)/); 
var n = Number(matches[0])+1;
